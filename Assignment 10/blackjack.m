...
while again == 'y'
   ...
   disp_cards('You', player_cards, mode);
   stood = 1;
   %% Player loop
   while true
   ...
   if stood
       if dealer_total > player_total
           disp(['Dealer total ', dealer_total, ' greater than your ', player_total', ...
               '. You lose.']);
           fund = fund - bet;
       elseif dealer_total < player_total
           disp(['Dealer total ', dealer_total, ' less than your ', player_total', ...
               '. You win!']);
           fund = fund + bet;
       else
